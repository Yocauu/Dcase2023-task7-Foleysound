...
if __name__ == '__main__':
    ...
    if args.hier == 'top':
        ...
        model = PixelSNAIL([10, 43], 512, 256, 5, 4, 4, 256, dropout=0.1, n_out_res_block=0, cond_res_channel=0)


    elif args.hier == 'bottom':
        model = PixelSNAIL( [20, 86], 512, args.channel, 5, 4, args.n_res_block, args.n_res_channel,
                            dropout=args.dropout, n_cond_res_block=args.n_cond_res_block, cond_res_channel=args.n_res_channel,)
